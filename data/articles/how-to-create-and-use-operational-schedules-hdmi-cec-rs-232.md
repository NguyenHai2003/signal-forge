...
content_hash: e599cc4695975d7673bb17b24bbaad824c454981ed91a8bf56392cab1b4b13f3
---
...
![Image from OptiSigns Help Center](https://support.optisigns.com/hc/article_attachments/28598173050899)
...
![Image from OptiSigns Help Center](https://support.optisigns.com/hc/article_attachments/39032325151379)

**3.**If **Default Schedule** is selected, the time and days can adjusted by clicking **Edit**.

> Note:
> Advanced Scheduling
> will allow you to create your own schedule.

![Image from OptiSigns Help Center](https://support.optisigns.com/hc/article_attachments/39032349012883)

**4.**Select your **Operational Schedule**, assign your desired content, then click **Save.**

![Image from OptiSigns Help Center](https://support.optisigns.com/hc/article_attachments/39032349013267)
...
![Image from OptiSigns Help Center](https://support.optisigns.com/hc/article_attachments/39032349024531)
...
![Image from OptiSigns Help Center](https://support.optisigns.com/hc/article_attachments/40739915922835)
...
1. 1. **Name:** Create a name for your schedule. We ***highly recommend*** doing this so as to differentiate it from other Operational Schedules you may wish to make.
   2. **Time:**This is the time of your event, click on it to edit the day and time.![Image from OptiSigns Help Center](https://support.optisigns.com/hc/article_attachments/28598178564627)
   3. **Repeat:**Choose whether you'd like your event to repeat from the available options, or create your own custom repeat.![Image from OptiSigns Help Center](https://support.optisigns.com/hc/article_attachments/28598178568211)
   4. **Power:** Choose from On, Off, HDMI-CEC On or Off, or RS-232 On or Off.
      ...
      * **RS-232 - Off:**Sends a command to turn the screen **OFF** through RS-232 during the designated hours.
        ...
        ![Image from OptiSigns Help Center](https://support.optisigns.com/hc/article_attachments/28598178570771)
...
![Image from OptiSigns Help Center](https://support.optisigns.com/hc/article_attachments/28598178573587)

**4.**Once applied, click **Save** to apply and activate all changes to your screens.

![Image from OptiSigns Help Center](https://support.optisigns.com/hc/article_attachments/28598173087891)
