...
content_hash: b60be47f6827c7a25472b104a09becfbd709a7c9406ccc6a2ac80ddf6fe510fd
---
...
> IMPORTANT
> With the launch of the Amazon Signage Stick, Amazon has been removing support for digital signage on FireSticks. As such, OptiSigns will be ending its support for Amazon Firesticks in the near future
> .
> We recommend our OptiStick device, or the Amazon Signage Stick.
> Also in 2024,
> Amazon released an update to FireOS
> disallowing apps to be autostarted on device boot up. Amazon has also released a
> Digital Signage Stick
> to replace the FireStick as a digital signage option.
> Amazon is also pushing advertising services,
> so device playback may be randomly interrupted.
> For these reasons, we no longer recommend FireStick as a digital signage player. We recommend an Amazon Signage Stick, Windows or Linux device, Chromecast, or our
> Android Player Stick
> .
